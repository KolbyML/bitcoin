...
extern UniValue listmasternodes(const UniValue& params);
extern UniValue getmasternodecount(const UniValue& params);
extern UniValue createmasternodebroadcast(const UniValue& params);
extern UniValue decodemasternodebroadcast(const UniValue& params);
extern UniValue relaymasternodebroadcast(const UniValue& params);
extern UniValue masternodecurrent(const UniValue& params);
extern UniValue startmasternode(const UniValue& params);
extern UniValue createmasternodekey(const UniValue& params);
extern UniValue getmasternodeoutputs(const UniValue& params);
extern UniValue listmasternodeconf(const UniValue& params);
extern UniValue getmasternodestatus(const UniValue& params);
extern UniValue getmasternodewinners(const UniValue& params);
extern UniValue getmasternodescores(const UniValue& params);
extern UniValue mnsync(const UniValue& params);
